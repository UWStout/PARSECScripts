...
parser = argparse.ArgumentParser(
    prog='subparseTest', description='Testing subparser')
...
project_parser.add_argument(
    '--path', action='store', help='Specify project path.')
project_parser.add_argument('--images', action='store',
                            help='Path to the folder containing subject images.')
project_parser.add_argument(
    '--name', action='store', help='A prefix to apply to log and MetaShape file names.')
...
project_parser.add_argument('--new', action='store_true',
                            help='Saves project in location specified by filepath.')
